...
class MakeBlackJack:
    ...
    def select_HDPS_from_basic_strategy(self, PC, DC):
        ...
        '''
        return table.loc[str(PC), str(DC)]
        ...
        while True:
            ...
            if 'A' in str(dealer_card):
                ...
                if dealer_score >= 17:
                    break
            #ヒット
            dealer_card.append(card_list_index[0])
